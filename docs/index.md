...
The active project studies how hidden hard-sphere collision correlations can become
a reversible, branchable, and editable animation representation.
...
4. [Collision-History Echoes route](research/collision-history-echo-route.md)
5. [Deng–Hani–Ma connection](research/deng-hard-sphere-connection.md)
6. [Paper positioning](vision/paper-positioning.md)
7. [Venue strategy](vision/venue-strategy.md)
8. [Active E0–E6 suite](benchmarks/echo-branching-suite.md)
9. [Graph and branching architecture](architecture/collision-history-graph-and-branching.md)
10. [First stage](roadmap/molecular-echo-first-stage.md)
11. [Go/No-Go gates](roadmap/go-no-go-gates.md)
12. [Hero scenes](demos/hero-scenes.md)
...
A beautiful reverse movie cannot repair a failed E0/E1/E2 gate, and a decorative
graph cannot replace E4 branch correctness.
